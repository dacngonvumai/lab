...
@Component({
  selector: 'app-detaillab8',
  templateUrl: './detaillab8.component.html',
  styleUrls: ['./detaillab8.component.css']
})
export class Detaillab8Component implements OnInit {
  ...
  ngOnInit() {
    ...
    this.info= this.dulieu.find(result => result.id ===this.pId);
